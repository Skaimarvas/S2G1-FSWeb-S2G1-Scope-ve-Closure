...
/*Görev 1: macSkoru()
  ...
  skor1 kodları scope kapsamına, skor2 ise closure kapsamına girer. skor1'de fonkisyon içinde tanımlanan değişkene sadece o fonksiyon kapsamında erişilebilir. Ama skor2 yani closure kapsamında, kendi kapsamı dışındaki değişkenlere erişebilir. Farkı budur.

  
  2. Hangisi bir closure kullanmaktadır? Nasıl tarif edebilirsin? (yarınki derste öğreneceksin :) )
  
  skor2'de closure kullanılmaktadır. Fonksiyon dışındaki skor değişkenine erişebilmektedir.

  3. Hangi durumda skor1 tercih edilebilir? Hangi durumda skor2 daha mantıklıdır?

  skor1 scope kapsamı, fonksiyon içindeki başka değişkenlerle çakışmaması için tercih edilir. Skor2 yani closure ise kendi kapsamı dışındaki değişkenlere ulaşmak istediğimizde tercih edilir. 
*/
